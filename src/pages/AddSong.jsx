...
const AddSong = () => {
    ...
    const loadAlbumData = async () => {
        try {
            ...
            toast.error("There is an error in loading album data");
        }
    }
    ...
    return loading ? (
        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-grey-600'>
            ...
            <button type='submit' className='text-base bg-black text-white py-2.5 px-14 cursor-pointer' disabled={loading}>ADD</button>
        </form>
    )
}
